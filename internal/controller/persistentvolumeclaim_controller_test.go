...
var _ = Describe("PersistentVolumeClaimController controller", func() {
	...
	It("should remove finalizer", func() {
		...
		testCases := []struct {
			...
			{
				title: "there are the finalizers",
				pvcMeta: metav1.ObjectMeta{
					Name:      "pvc4",
					Namespace: ns,
					Finalizers: []string{
						"topols.kvaster.com/pvc",
					},
				},
				expectFinalizers: []string{
					"topols.kvaster.com/pvc",
	...
	It("should be deleted Pods which is using PVC that has finalizer", func() {
		...
		pods := []corev1.Pod{
			...
			// this pod will not be deleted because this pod doesn't used TopoLS's PVC
			{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "pod1",
					Namespace: ns1,
		...
		pvcMetas := []metav1.ObjectMeta{
			// this PVC has a finalizer of TopoLS
			{
				Name:      "pvc0",
				Namespace: ns1,
				Finalizers: []string{
			...
			// this PVC doesn't have a finalizer of TopoLS
			{
				Name:       "pvc1",
				Namespace:  ns1,
				Finalizers: []string{},
